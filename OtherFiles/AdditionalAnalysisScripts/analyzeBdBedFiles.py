...
bedList = ['PAC2_0.283-PAC2_0.323_5.bed','PAC2_0.283-PAC2_0.275_5.bed','PAC2_0.283-PAC2_0.285_5.bed',
 'PAC2_0.283-PAC2_0.308_5.bed','PAC2_0.283-PAC2_0.311_5.bed',
 'PAC2_0.283-PAC2_0.312_5.bed','PAC2_0.283-PAC2_0.313_5.bed','PAC2_0.283-PAC2_0.316_5.bed',
 'PAC2_0.283-PAC2_0.167_5.bed','PAC2_0.283-PAC2_0.383_5.bed']

omitted = ['PAC2_0.283-PAC2_0.296_5.bed']
...
for line in inputFileLines[1:]:
    histogramIntFile.write('283-%s\t%s\t%s\n'%(tuple(line.split()[0:3])))
...
outIntersectHist = open('283.syntBP.conservedAmongAllSpecies.histogram.txt','w')
outMergeHist = open('283.syntBP.mergedOverlappingIntervalsAllSpecies.histogram.txt','w')
